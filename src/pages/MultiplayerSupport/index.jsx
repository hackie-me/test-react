...
const MultiplayerSupportPage = () => {
  return (
    <>
      <div className="bg-gray_900_06 font-gilroy h-[1024px] mx-auto relative w-full">
        <div
        ...
        >
          <div className="bg-gray_900_07 h-[1024px] w-full"></div>
        </div>
          ...
          >
              ...
              <div className="h-[175px] md:h-[214px] mb-[23px] mt-4 relative w-full">
                ...
                <div className="absolute bottom-[3%] flex sm:flex-col flex-row sm:gap-10 items-end justify-between left-[6%] w-[82%]">
                  <Img
                    ...
                    alt="Vector Three"
                  />
                  <Text className="text-white_A700 uppercase" variant="body5">
                    Single Player
                  </Text>
                </div>
              </div>
            ...
            <div className="flex flex-col items-center justify-start w-full">
              <div className="h-[175px] md:h-[214px] sm:h-[241px] mb-[23px] mt-4 relative w-full">
                ...
                <Text
                  className="absolute bottom-[3%] right-[13%] text-white_A700 uppercase"
                  variant="body5"
                >
                  Multi Player
                </Text>
