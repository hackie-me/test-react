...
const SettingsOnePage = () => {
  return (
    <>
      <div className="bg-gray_50_01 flex sm:flex-col md:flex-col flex-row font-gilroy gap-[30px] items-start mx-auto sm:pr-5 pr-8 w-full">
        ...
        <div className="flex flex-1 flex-col items-center justify-start md:mt-0 mt-8 md:px-5 w-full">
          <div className="flex md:flex-col flex-row md:gap-5 items-end justify-start w-full">
            <Text
              className="font-semibold md:mt-0 mt-[15px] text-blue_gray_900"
              variant="body2"
            >
              Settings
            </Text>
          ...
          <div className="sm:h-[329px] h-[41px] md:h-[69px] mt-8 pt-1 relative w-full">
            ...
            <div className="absolute bottom-[0] flex sm:flex-col flex-row gap-[34px] items-start justify-between left-[3%] w-[69%]">
              ...
              <Text className="font-medium text-blue_gray_400" variant="body13">
                Notifications
              </Text>
              <Text className="font-medium text-blue_gray_400" variant="body13">
                Language
          ...
          <div className="flex flex-col gap-6 items-center justify-start mt-[59px] w-[49%] md:w-full">
