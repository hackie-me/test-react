        ...
        <div className="flex flex-col items-center justify-end max-w-[1268px] mx-auto md:px-5 w-full">
          <div className="flex md:flex-col flex-row md:gap-10 items-start justify-between w-full">
            <div className="flex flex-col items-center justify-start md:mt-0 mt-[50px]">
              <div className="flex flex-row sm:gap-10 items-center justify-between pt-2 w-full">
                <Img
              ...
              <Img
                ...
                className="h-[450px] md:h-auto mt-[51px] object-cover rounded-lg w-[450px] sm:w-full"
                alt="Rectangle1224"
              />
              <div className="flex flex-col gap-6 items-center justify-start mt-14 w-full">
            ...
            <Line className="bg-blue_gray_100 h-[980px] md:h-px mb-[243px] md:w-full w-px" />
            <div className="flex flex-col gap-[30px] items-start justify-start md:mt-0 mt-[30px]">
              <div className="flex flex-row gap-4 items-end justify-start rounded-[3.2px] w-[70%] md:w-full">
                <Img
                  src="images/img_rectangle20_78X78.png"
                  className="h-[180px] md:h-auto object-cover rounded-[3.2px] w-[180px]"
                  alt="Rectangle1224 One"
                />
                <div className="flex flex-col gap-[15px] items-start justify-start mt-[113px]">
                  <Text
                    className="font-semibold text-blue_gray_900"
                    variant="body7"
                  >
