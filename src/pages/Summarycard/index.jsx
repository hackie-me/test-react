        ...
        <div className="flex md:flex-col flex-row gap-7 items-start justify-start max-w-[1268px] mx-auto md:px-5 w-full">
          <div className="bg-white_A700 flex md:flex-1 flex-col md:gap-10 gap-[70px] items-center justify-start p-4 rounded-lg shadow-bs1 w-[68%] md:w-full">
            <div className="flex flex-col gap-[23px] items-start justify-start w-[97%] md:w-full">
              ...
              ></Input>
              <List
                className="flex-col gap-6 grid w-[77%]"
                orientation="vertical"
              >
                <div className="flex sm:flex-col flex-row gap-4 items-center justify-between pt-1.5 w-full">
                  <Img
          ...
          <div className="bg-white_A700 flex md:flex-1 flex-col gap-8 items-center justify-start mb-[853px] p-4 rounded-lg shadow-bs1 w-[31%] md:w-full">
