...
const FeedbackCollectionPage = () => {
  ...
  return (
    <>
      <div className="bg-gray_50 flex flex-col font-gilroy items-start justify-start mx-auto w-full">
            ...
            items={[...Array(6)].map(() => (
              <React.Fragment key={Math.random()}>
                <div className="flex flex-col items-center justify-start mx-2.5">
                  ...
                  >
                    <div className="bg-white_A700 flex flex-1 sm:flex-col flex-row md:gap-10 items-center justify-between my-0 p-4 rounded-md shadow-bs4 w-full">
                      <div className="flex flex-col items-start justify-start mb-0.5 ml-4 sm:ml-[0] sm:mt-0 mt-1.5">
                        ...
                        <Text
                          className="font-medium mt-[18px] text-black_900_01"
                          variant="body13"
                        >
                      ...
                      <Text
                        className="bg-blue_50 font-medium h-[26px] justify-center mb-[72px] mr-4 pl-2 pr-1 py-[5px] rounded-[3px] text-blue_A700_01 w-[87px]"
                        variant="body15"
                      >
                        18/05/2022
                      </Text>
