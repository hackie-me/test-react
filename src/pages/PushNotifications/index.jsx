...
const PushNotificationsPage = () => {
  return (
    <>
      <div
        className="bg-cover bg-no-repeat bg-white_A700 flex flex-col font-gilroy h-[1024px] items-center justify-end mx-auto pt-[714px] w-full"
        style={{ backgroundImage: "url('images/img_automatedemail.png')" }}
      >
        <div className="flex flex-col gap-5 justify-start w-full">
          <div className="bg-white_A700 flex flex-col items-center justify-start md:ml-[0] ml-[1014px] mr-6 p-4 md:px-5 rounded-[13px] w-[28%] md:w-full">
            <List
              className="flex-col gap-2.5 grid items-center rounded w-full"
