    ...
    <>
      <div className="bg-gray_50 flex flex-col font-gilroy items-center justify-start mx-auto w-full">
        <div className="flex md:flex-col flex-row gap-[30px] items-start justify-between mx-auto md:px-5 w-full">
          ...
          <div className="flex flex-1 flex-col gap-12 items-center justify-start md:mt-0 mt-8 w-full">
            ...
            <div className="flex flex-col gap-[26px] items-start justify-start w-[65%] md:w-full">
              <div className="flex flex-col gap-8 items-start justify-start pt-[7px] w-[55%] md:w-full">
