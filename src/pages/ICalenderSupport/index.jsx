    ...
    <>
      <div className="bg-gray_50 flex flex-col font-gilroy items-center justify-start mx-auto w-full">
        <div className="flex md:flex-col flex-row gap-[30px] items-start justify-between mx-auto md:px-5 w-full">
          ...
          <div className="flex flex-1 flex-col gap-[30px] items-center justify-start md:mt-0 mt-8 w-full">
            ...
            <div className="flex flex-col gap-8 items-center justify-start pt-0.5 w-[65%] md:w-full">
...
export default ICalenderSupportPage;
