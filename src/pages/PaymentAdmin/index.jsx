                ...
                <div className="flex flex-col gap-[31px] items-start justify-start w-full">
                  ...
                  <div className="flex flex-col gap-[30px] items-center justify-start w-full">
                    <div className="flex flex-col items-center justify-start w-full">
                      <div className="bg-blue_50 flex flex-row md:gap-10 items-center justify-between p-2 rounded-tl-md rounded-tr-md w-full">
                        <Text
                          className="font-medium ml-4 mt-[7px] text-blue_gray_900"
                          variant="body12"
                        >
                          Activity
                        </Text>
                        <Text
                          className="font-bold mr-4 text-blue_A700_01"
                          variant="body12"
                        >
                          View All
                        </Text>
