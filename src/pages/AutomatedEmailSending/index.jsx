          ...
          <div className="bg-blue_50_01 flex flex-col items-center justify-start md:ml-[0] ml-[1020px] mr-6 p-4 md:px-5 rounded-[10px] w-[28%] md:w-full">
            <div className="flex flex-col items-start justify-start w-full">
              <div className="flex flex-row font-gilroy gap-2 items-end justify-start w-[52%] md:w-full">
                <Text
                  className="bg-blue_A700_01 border-2 border-solid border-white_A700 flex font-semibold h-[45px] items-center justify-center rounded-[50%] text-center text-white_A700 w-[45px]"
                  variant="body11"
                >
                  S
                </Text>
                <div className="flex flex-col gap-[9px] items-start justify-start mt-[5px]">
                  <Text
              ...
              <Text
                className="font-gilroy font-medium mt-[27px] text-blue_gray_900"
                variant="body13"
              >
                Hello Users,
              </Text>
              <Text
                className="font-gilroy font-medium mt-[13px] text-blue_gray_900"
                variant="body13"
              >
              ...
              />
              <Text
                className="font-josefinsans font-normal md:ml-[0] ml-[131px] mt-3 text-orange_A700"
                variant="body11"
              >
                Say It Now
              </Text>
              <Text
                className="font-gilroy font-medium leading-[22.00px] mt-6 text-blue_gray_900 w-full"
                variant="body15"
              >
                Your payment of $79 is due on Wednesday, 22th May 2021.
              </Text>
              <Text
                className="font-gilroy font-medium leading-[22.00px] mt-4 text-blue_gray_900 w-full"
                variant="body15"
              >
              ...
              <Text
                className="font-gilroy font-medium mt-[21px] text-blue_gray_900"
                variant="body15"
              >
                Thank you.
              </Text>
