  ...
  return (
    <>
      <div className="bg-gray_50_01 flex sm:flex-col md:flex-col flex-row font-gilroy gap-[30px] items-start mx-auto sm:pr-5 pr-6 w-full">
        ...
        <div className="flex-1 sm:h-[1056px] h-[1109px] md:h-[1965px] md:mt-0 mt-6 md:px-5 relative w-full">
                ...
                <div className="bg-white_A700 flex flex-col items-center justify-end md:mt-0 mt-11 pt-5 px-5 rounded-md w-[46%] md:w-full">
                  <div className="md:h-[201px] h-[350px] relative w-[96%]">
                    ...
                    <div className="absolute flex flex-col gap-11 items-start justify-start left-[0] pt-0.5 top-[0] w-[77%]">
                      <div className="flex flex-row items-end justify-start w-1/4 md:w-full">
                        <Img
