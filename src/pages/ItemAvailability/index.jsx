    ...
    <>
      <div className="bg-gray_50 flex flex-col font-gilroy sm:gap-10 md:gap-10 gap-[70px] items-center justify-end mx-auto w-full">
        ...
        <div className="flex md:flex-col flex-row gap-7 items-start justify-start max-w-[1268px] mx-auto md:px-5 w-full">
          <div className="bg-white_A700 flex md:flex-1 flex-col gap-12 items-center justify-start p-4 rounded-lg shadow-bs1 w-[68%] md:w-full">
              ...
              <div className="flex md:flex-col flex-row gap-4 items-center justify-start pt-1.5 w-[77%] md:w-full">
                ...
                <div className="flex flex-col items-start justify-start w-[66%] md:w-full">
                  ...
                  <div className="flex flex-col font-gilroy items-start justify-end mt-3 pr-[3px] py-[3px] w-full">
                    <Text
                      className="font-medium mt-[7px] text-red_700"
                      variant="body12"
                    >
            ...
            <div className="flex flex-col gap-[23px] items-center justify-start mb-[38px] w-[97%] md:w-full">
          ...
          <div className="bg-white_A700 flex md:flex-1 flex-col gap-8 items-center justify-start mb-[623px] p-4 rounded-lg shadow-bs1 w-[31%] md:w-full">
