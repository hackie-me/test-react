      ...
      <div className="bg-gray_50 flex flex-col font-gilroy sm:gap-10 md:gap-10 gap-[70px] items-center justify-start mx-auto w-full">
        ...
        <div className="flex md:flex-col flex-row gap-7 items-start justify-start max-w-[1268px] mx-auto md:px-5 w-full">
          <div className="flex md:flex-1 flex-col items-center justify-end pt-4 px-4 w-[68%] md:w-full">
            <div className="bg-white_A700 flex flex-col items-center justify-start rounded-lg shadow-bs1 w-[97%] md:w-full">
              <div className="overflow-x-auto w-full">
                <div className="h-[966px] md:h-[982px] relative rounded-lg w-full">
                  <div className="bg-white_A700 h-[982px] m-auto rounded-lg shadow-bs1 w-full"></div>
                  <div className="absolute flex flex-col gap-[50px] inset-x-[0] items-center justify-start mx-auto top-[0] w-full">
                    ...
                    <div className="border border-blue_gray_100 border-solid flex flex-col items-center justify-start p-4 w-full">
                  ...
                  <div className="absolute bottom-[0] flex flex-col inset-x-[0] items-center justify-start mx-auto w-full">
                    ...
                    <div className="bg-white_A700 border border-blue_gray_100 border-solid flex flex-col items-center justify-start mt-[23px] p-4 rounded w-full">
                    ...
                    <div className="bg-white_A700 border border-blue_gray_100 border-solid flex flex-col items-start justify-start mt-6 p-4 rounded w-full">
                    ...
                    <div className="bg-white_A700 border border-blue_gray_100 border-solid flex flex-col items-start justify-end mt-6 pt-4 px-4 rounded w-full">
                    ...
                    <div className="bg-white_A700 border border-blue_gray_100 border-solid flex sm:flex-col flex-row gap-6 items-start justify-start mt-[60px] pt-4 px-4 w-full">
                      <Img
                      ...
                      />
                      <Text
                        className="font-medium sm:mt-0 mt-[11px] text-black_900_01"
                        variant="body11"
                      >
                        Add Address
                      </Text>
          ...
          <div className="bg-white_A700 flex md:flex-1 flex-col gap-8 items-center justify-start mb-[551px] p-4 rounded-lg shadow-bs1 w-[31%] md:w-full">
