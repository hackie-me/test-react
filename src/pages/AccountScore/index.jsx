  ...
  return (
    <>
      <div className="bg-gray_50_01 flex sm:flex-col md:flex-col flex-row font-gilroy gap-[30px] items-start mx-auto sm:pr-5 pr-6 w-full">
        ...
        <div className="flex-1 sm:h-[1056px] h-[1109px] md:h-[2021px] md:mt-0 mt-6 md:px-5 relative w-full">
          <div className="absolute flex flex-col gap-[31px] inset-x-[0] items-center justify-start mx-auto top-[1%] w-full">
            ...
            <div className="flex flex-col gap-10 items-start justify-start w-full">
              <div className="flex md:flex-col flex-row gap-[30px] items-end justify-start w-[73%] md:w-full">
                <div className="flex flex-col gap-6 items-center justify-start w-[51%] md:w-full">
                  ...
                  >
                    <div className="flex flex-col items-center justify-start w-[45%] md:w-full">
                      ...
                      <Text
                        className="font-semibold mt-[23px] text-blue_A700_01"
                        variant="body7"
                      >
                        Account Score
                      </Text>
                      <Text
                        className="font-normal mt-[21px] text-blue_gray_400"
                        variant="body13"
                      >
                        Actively liberal
                      </Text>
                  ...
                  >
                    <div
                      className="bg-cover bg-no-repeat flex flex-1 flex-col h-[135px] items-center justify-end p-2 w-full"
                      style={{
                        backgroundImage: "url('images/img_graphpie.svg')",
                      }}
                    >
                      <div className="flex flex-col gap-[21px] items-center justify-start mt-1 w-[97%] md:w-full">
                ...
                <div className="bg-white_A700 flex flex-col items-center justify-end md:mt-0 mt-11 pt-5 px-5 rounded-md w-[46%] md:w-full">
                  <div className="flex flex-col gap-11 items-start justify-start pt-0.5 w-[96%] md:w-full">
                    <div className="flex flex-row items-end justify-start w-[19%] md:w-full">
                      <Img
                      ...
                      />
                      <Text
                        className="font-medium ml-[5px] mt-[5px] text-black_900"
                        variant="body12"
                      >
                        Tip
                      </Text>
                    </div>
                    <div className="md:h-[186px] h-[277px] relative w-full">
                      <Img
                        src="images/img_businessmanpoi.png"
                        className="absolute bottom-[0] h-[186px] object-cover right-[0] w-[55%]"
                        alt="businessmanpoi"
                      />
                      <div className="absolute flex flex-col gap-4 items-start justify-start left-[0] rounded-md top-[0] w-[77%]">
                        <Text
                          className="font-medium leading-[26.00px] text-blue_gray_400 w-full"
                          variant="body13"
                        >
...
export default AccountScorePage;
