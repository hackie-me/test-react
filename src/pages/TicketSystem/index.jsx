          ...
          <div className="flex md:flex-col flex-row gap-8 items-start justify-start md:px-5 w-1/2 md:w-full">
            ...
            <div className="flex flex-1 flex-col gap-7 items-start justify-start md:mt-0 mt-[39px] w-full">
              ...
              <div className="flex flex-col items-center justify-start w-full">
                <div className="bg-white_A700 flex flex-col gap-[11px] items-center justify-start p-[3px] rounded-lg w-full">
                  ...
                  <div className="flex flex-col gap-4 items-start justify-start mb-[13px] w-[93%] md:w-full">
                    ...
                    <Button
                      className="cursor-pointer font-medium text-center text-sm text-white_A700 w-[342px]"
