      ...
      <div className="bg-gray_50_05 flex flex-col font-gilroy items-center justify-start mx-auto w-full">
        <div className="flex flex-col items-center justify-start w-full">
          ...
          <div className="flex md:flex-col flex-row gap-8 items-start justify-between mx-auto md:px-5 w-full">
            ...
            <div className="flex flex-1 flex-col md:mt-0 mt-8 relative w-full">
              <div className="flex flex-col gap-7 items-center justify-start mx-auto w-full">
                <div className="flex md:flex-col flex-row md:gap-5 items-end justify-start rounded-md w-full">
                  <Text
                    className="font-semibold md:mt-0 mt-[9px] text-blue_gray_900"
                    variant="body7"
                  >
                    My Tasks
                  </Text>
                  ...
                  <Button
                    className="cursor-pointer flex items-center justify-center min-w-[75px] ml-6 md:ml-[0] md:mt-0 my-0.5"
                    leftIcon={
                      <Img
                ...
                >
                  <div className="flex flex-1 flex-col gap-4 items-start justify-start w-full">
                    ...
                    <div className="flex flex-col gap-4 items-center justify-start w-full">
                      <div className="bg-white_A700 flex flex-col items-center justify-start p-3.5 rounded-md shadow-bs4 w-full">
                        <div className="flex md:flex-col flex-row md:gap-5 items-start justify-start w-[99%] md:w-full">
                          <Text
                            className="font-semibold md:mt-0 mt-2 text-gray_900_10"
                            variant="body13"
                          >
                            Buy groceries{" "}
                          </Text>
                          <Button
                            className="cursor-pointer font-medium min-w-[94px] md:ml-[0] ml-[778px] text-center text-red_700 text-sm"
                            shape="RoundedBorder3"
                            size="sm"
                            variant="FillGray10002"
                          >
                            High Priority
                          </Button>
                          <Img
                      ...
                      <div className="bg-white_A700 flex flex-col items-center justify-start p-3.5 rounded-md shadow-bs4 w-full">
                        <div className="flex md:flex-col flex-row md:gap-5 items-start justify-start w-[99%] md:w-full">
                          <Text
                            className="font-semibold md:mt-0 mt-[7px] text-gray_900_10"
                            variant="body13"
                          >
                            Cardio at 6 pm
                          </Text>
                          <Button
                            className="cursor-pointer font-medium min-w-[90px] md:ml-[0] ml-[771px] text-center text-deep_orange_400 text-sm"
                            shape="RoundedBorder3"
                            size="sm"
                  ...
                  <div className="flex flex-1 flex-col gap-4 items-start justify-start w-full">
                    ...
                    <div className="flex flex-col gap-4 items-center justify-start w-full">
                      ...
                      <div className="bg-white_A700 flex flex-col items-center justify-start p-3.5 rounded-md shadow-bs4 w-full">
                        <div className="flex flex-row md:gap-10 items-end justify-between rounded w-full">
                          <Text
                            className="font-semibold mb-0.5 mt-[7px] text-gray_900_10"
                            variant="body13"
                          >
                            Cardio at 6 pm
                          </Text>
                          <div className="flex flex-row gap-[38px] items-start justify-between rounded w-[16%]">
                            <Button
                              className="cursor-pointer font-medium min-w-[90px] text-center text-deep_orange_400 text-sm"
                              shape="RoundedBorder3"
                              size="sm"
                              variant="FillDeeporange50"
                            >
                            ...
                            <div className="bg-blue_gray_50 h-6 md:h-[30px] my-[3px] px-0.5 relative rounded w-[18%]">
                              <Img
                                src="images/img_user.svg"
              ...
              <div className="bg-white_A700 flex flex-col items-start justify-start ml-auto mr-[37px] mt-[-24px] p-4 rounded-md shadow-bs4 z-[1]">
                <Text
                  className="font-medium mt-[5px] text-black_900"
                  variant="body15"
                >
                  Make High Priority
                </Text>
                <Text
                  className="font-medium mt-[21px] text-black_900"
                  variant="body15"
                >
                  Move to Top
                </Text>
                <Text
                  className="font-medium mt-5 text-black_900"
                  variant="body15"
                >
                  Edit
                </Text>
                <Text
                  className="font-medium mb-1 mt-[23px] text-red_700"
                  variant="body15"
                >
                  Delete
                </Text>
