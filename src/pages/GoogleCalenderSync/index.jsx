    ...
    <>
      <div className="bg-gray_50 flex flex-col font-gilroy gap-[50px] items-center justify-start mx-auto w-full">
        ...
        <div className="flex md:flex-col flex-row gap-[30px] items-start justify-between max-w-[1380px] mx-auto md:px-5 w-full">
          <div className="flex md:flex-1 flex-col gap-[30px] items-center justify-start mb-[35px] w-[77%] md:w-full">
            <div className="flex sm:flex-col flex-row md:gap-10 items-center justify-between w-full">
              ...
              <div className="flex sm:flex-1 flex-row gap-6 items-center justify-between w-[29%] sm:w-full">
                ...
                <Button
                  className="cursor-pointer font-medium min-w-[62px] text-base text-center text-white_A700"
            ...
            <div className="flex flex-col items-end justify-start w-full">
              ...
              >
                ...
                <div className="bg-gray_50_01 flex flex-col gap-[11px] items-start justify-start outline outline-[1px] outline-blue_gray_50 p-[7px] w-full">
                  ...
                  <Text
                    className="font-semibold h-6 mb-[15px] text-black_900_01"
                    variant="body7"
                  >
                    27
                  </Text>
          ...
          <div className="bg-white_A700 border border-blue_gray_50 border-solid flex md:flex-1 flex-col items-center justify-start md:mt-0 mt-[76px] p-3 rounded-md w-[22%] md:w-full">
              ...
              >
                ...
                <div className="flex flex-1 flex-row items-center justify-start my-0 w-full">
                  <div className="flex flex-col items-center justify-end p-1 w-[15%]">
                    ...
                    <div className="bg-blue_A700_01 h-1 mt-1 rounded-[50%] w-1"></div>
                  </div>
                  <div className="flex flex-col items-center justify-end p-1 w-[15%]">
                    <Text
                      className="font-semibold mt-[3px] text-blue_gray_400"
