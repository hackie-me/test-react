          ...
          <div className="flex md:flex-col flex-row gap-8 items-start justify-between mx-auto md:px-5 w-full">
            ...
            <div className="flex flex-1 flex-col gap-6 items-center justify-start md:mt-0 mt-8 w-full">
              <div className="flex flex-row md:gap-10 items-center justify-between w-full">
                ...
                <Button
                  className="cursor-pointer font-medium min-w-[161px] text-base text-center text-white_A700"
              ...
              >
                <div className="bg-white_A700 flex flex-1 flex-col items-center justify-start p-6 sm:px-5 rounded-md w-full">
                  <div className="flex flex-col gap-6 items-start justify-start pr-[5px] py-[5px]">
                    ...
                    <Text
                      className="font-semibold mb-0.5 text-blue_gray_900"
                      variant="body4"
                    >
                      $50,000
                    </Text>
                  ...
                  <div className="flex flex-col gap-6 items-start justify-start w-full">
                    ...
                    <div className="flex md:flex-col flex-row gap-4 items-center justify-between w-full">
                      <div className="flex flex-col gap-[17px] items-start justify-start pb-1 pl-1">
                        ...
                        <Text
                          className="font-normal h-4 ml-2.5 md:ml-[0] text-blue_gray_900"
                          variant="body15"
                        >
                          5K
                        </Text>
                        <Text
                          className="font-normal mb-5 md:ml-[0] ml-[9px] text-blue_gray_900"
                          variant="body15"
                        >
                          0K
                        </Text>
