...
const ScreenshotEditorPage = () => {
  return (
    <>
      <div className="bg-gray_50_01 font-gilroy h-[1080px] mx-auto relative w-full">
        <div className="absolute bottom-[0] sm:h-[1056px] h-[1109px] md:h-[2089px] md:px-5 right-[2%] w-[76%] md:w-full">
        ...
        <Sidebar className="!sticky !w-[300px] flex h-screen md:hidden justify-start my-auto overflow-auto md:px-5 top-[0]">
        ...
        <div className="absolute bg-black_900_b2 flex flex-col h-full inset-[0] items-start justify-center m-auto p-[164px] md:px-10 sm:px-5 w-full">
          <div className="flex flex-col gap-1.5 justify-start mb-[156px] mt-[9px] w-[79%] md:w-full">
            <div className="flex md:flex-col flex-row md:gap-5 items-end justify-end w-full">
              <div
                className="bg-cover bg-no-repeat flex md:flex-1 flex-col h-[587px] items-center justify-start p-1 w-[94%] md:w-full"
                style={{ backgroundImage: "url('images/img_group3132.svg')" }}
              >
                <div className="flex flex-col items-center justify-start w-full">
                  <div className="flex flex-row sm:gap-10 items-start justify-between w-full">
                    <Img
                      src="images/img_anchorpoint.svg"
                      className="h-6 w-6"
                      alt="AnchorPoint"
                    />
                    <div className="bg-white_A700 h-0.5 mb-[22px] rounded-[1px] w-[3%]"></div>
                    <Img
                      src="images/img_anchorpoint_24X24.svg"
                      className="h-6 w-6"
                      alt="AnchorPoint Two"
                    />
                  </div>
                  <div className="flex md:flex-col flex-row md:gap-10 items-center justify-between mt-[3px] w-full">
                    <Line className="bg-white_A700 md:h-0.5 h-6 md:mt-0 my-[252px] rounded-[1px] w-0.5 md:w-full" />
                    <div className="bg-gray_50_01 flex md:flex-1 md:flex-col flex-row gap-[30px] items-center justify-between w-[94%] md:w-full">
                      <div className="bg-gray_50 h-[528px] w-[13%]"></div>
                      <div className="flex flex-col items-end justify-end">
                        <div className="flex flex-col gap-10 items-start justify-end w-full">
                          <div className="flex md:flex-col flex-row gap-[30px] items-start justify-between w-full">
                            <div className="flex md:flex-1 flex-col gap-6 items-center justify-start w-[51%] md:w-full">
                              <div
                                className="bg-cover bg-no-repeat flex flex-col h-[255px] items-center justify-start p-4 w-full"
                                style={{
                                  backgroundImage:
                                    "url('images/img_group9824.svg')",
                                }}
                              >
                                <div className="flex flex-col gap-[23px] items-center justify-start w-[37%] md:w-full">
                                  <div className="h-[134px] relative rounded-[20px] w-[134px]">
                                    ...
                                    <Text
                                      className="absolute bottom-[31%] font-semibold inset-x-[0] mx-auto text-blue_gray_900 w-max"
                                      as="h6"
                                      variant="h6"
                                    >
                                      80%
                            ...
                            <div className="bg-white_A700 flex md:flex-1 flex-col items-start justify-start mb-1.5 md:mt-0 mt-11 p-4 rounded-md w-[46%] md:w-full">
                              <div className="flex flex-col md:gap-10 gap-[71px] items-center justify-start mb-[49px] mt-[11px] w-[86%] md:w-full">
                                <div className="flex flex-col items-start justify-end pt-2.5 w-[69%] md:w-full">
                                  <div className="flex flex-col items-start justify-start w-[86%] md:w-full">
                                    <Text
                                      className="font-semibold text-blue_gray_900_01"
                                      variant="body12"
                                ...
                                <div className="flex flex-row items-end justify-center w-[68%] md:w-full">
                                  <div className="bg-blue_A700_7e h-[98px] mt-[5px] rounded w-[17%]"></div>
                                  <div className="bg-blue_A700_7e h-[84px] ml-2 mt-[19px] rounded w-[17%]"></div>
                                  <div className="bg-blue_A700_7e h-[103px] ml-2 rounded w-[17%]"></div>
                                  <div className="bg-blue_A700_7e h-[70px] ml-2 mt-[33px] rounded w-[17%]"></div>
                                  <div className="bg-blue_A700_7e h-[98px] ml-2 mt-[5px] rounded w-[17%]"></div>
                                </div>
                              </div>
                            </div>
                          </div>
                          <div className="bg-white_A700 border border-blue_gray_100 border-solid flex flex-col items-center justify-end p-[21px] sm:px-5 rounded-md w-[88%] md:w-full">
                            <div className="flex flex-col gap-[21px] items-center justify-start mt-[3px] pb-[33px] w-full">
                              <div className="flex flex-row sm:gap-10 items-start justify-between w-full">
                                <div className="flex flex-col gap-[7px] items-start justify-start mt-[7px] w-[32%]">
                                  <Text
                                    className="font-semibold text-blue_gray_900"
                              ...
                              <div className="flex md:flex-col flex-row gap-[7px] items-start justify-between py-1 w-full">
                                <div className="flex flex-col gap-[26px] items-start justify-start">
                                  <Text
                                    className="font-normal text-blue_gray_900"
                                    variant="body15"
                                ...
                                <div
                                  className="bg-cover bg-no-repeat flex md:flex-1 flex-col h-[200px] items-end justify-start mb-2 md:mt-0 mt-1 p-[26px] sm:px-5 w-[96%] md:w-full"
                                  style={{
                                    backgroundImage:
                                      "url('images/img_group3133.png')",
                                  }}
                                >
                                  <div className="bg-black_900_01 flex flex-col items-center justify-center mb-[88px] mr-[143px] px-[11px] py-2.5 rounded-[5px] w-auto">
                                    <Text
                                      className="font-medium text-white_A700 w-auto"
                                      variant="body16"
                                    >
                  ...
                  <div className="flex flex-row sm:gap-10 items-start justify-between w-full">
                    <Img
                      src="images/img_anchorpoint.svg"
                      className="h-6 w-6"
                      alt="AnchorPoint Five"
                    />
                    <div className="bg-white_A700 h-0.5 mt-[22px] rounded-[1px] w-[3%]"></div>
                    <Img
                      src="images/img_anchorpoint_24X24.svg"
                      className="h-6 w-6"
                      alt="AnchorPoint Seven"
                    />
                  </div>
                </div>
              </div>
              <div className="bg-white_A700 flex md:flex-1 flex-col gap-6 items-center justify-start md:mt-0 mt-[199px] p-4 rounded w-[7%] md:w-full">
                ...
                <Img
                  ...
                  alt="upload"
                />
                <div className="border-2 border-black_900 border-solid h-5 rotate-[-90deg] w-full"></div>
                <Img src="images/img_cut.svg" className="h-6 w-6" alt="cut" />
                <Text className="h-6"></Text>
                <div className="bg-red_700_01 h-6 w-6"></div>
                <Img
            ...
            <Img
              src="images/img_frame10029.svg"
              className="h-14 md:ml-[0] ml-[539px] rounded w-[39%]"
              alt="Frame10029"
            />
          </div>
        </div>
