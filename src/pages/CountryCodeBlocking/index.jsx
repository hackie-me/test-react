...
const group10198FourOptionsList = [
  { label: "Option1", value: "option1" },
  { label: "Option2", value: "option2" },
  { label: "Option3", value: "option3" },
];

const CountryCodeBlockingPage = () => {
  return (
    <>
      <div className="bg-gray_50_01 flex flex-col font-gilroy items-center justify-start mx-auto w-full">
        <div className="flex md:flex-col flex-row gap-[30px] items-start justify-between mx-auto md:px-5 w-full">
          ...
          <div className="flex flex-1 flex-col md:gap-10 gap-[70px] items-center justify-start md:mt-0 mt-8 w-full">
            ...
            <div className="flex flex-col gap-6 items-center justify-start w-1/2 md:w-full">
              ...
              <div className="flex flex-col items-center justify-end pt-[5px] w-full">
                <div className="flex flex-col items-center justify-start w-full">
                  ...
                  <div className="flex flex-col items-start justify-start mt-[23px] w-full">
                    ...
                    <SelectBox
                      className="font-medium text-base text-blue_gray_300 text-left w-full"
                      placeholderClassName="text-blue_gray_300"
                      indicator={
                        <Img
                          src="images/img_arrowdown_black_900.svg"
                          className="h-6 mr-3.5 w-6"
                          alt="arrow_down"
                        />
                      }
                      size="3xl"
                      ...
                      shape="RoundedBorder6"
                      isMulti={false}
                      options={group10198FourOptionsList}
...
export default CountryCodeBlockingPage;
