      ...
      <div className="bg-gray_50_01 flex flex-col font-gilroy items-center justify-start mx-auto w-full">
        <div className="flex md:flex-col flex-row gap-[30px] items-start justify-between mx-auto md:px-5 w-full">
          ...
          <div className="flex flex-1 flex-col gap-8 items-center justify-start md:mt-0 mt-8 w-full">
            ...
            <div className="flex flex-col gap-14 items-center justify-start pt-1 w-full">
              ...
              <div className="flex flex-col gap-8 items-center justify-start w-[49%] md:w-full">
                ...
                <div className="flex flex-col gap-[30px] items-center justify-end pt-[7px] w-full">
                  <div className="flex flex-col items-start justify-start rounded-lg w-full">
                    ...
                    <Text
                      className="bg-white_A700 border border-blue_gray_100 border-solid font-medium h-[52px] justify-center pl-3 sm:pr-5 pr-[35px] py-[17px] rounded-lg text-blue_gray_300 w-[528px]"
                      variant="body13"
                    >
                      08
                    </Text>
                  </div>
                  <div className="flex flex-col gap-[7px] items-start justify-start rounded-lg w-full">
                    <Text
                      className="font-medium text-blue_gray_900"
                      variant="body12"
                    >
                      URL to Redirect Leech Users
                    </Text>
                    <Input
                  ...
                  <Button
                    className="cursor-pointer font-medium min-w-[528px] sm:min-w-full text-base text-center text-white_A700"
                    shape="RoundedBorder6"
                    size="xl"
...
export default LeechProtectionPage;
